...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-visual">
            <div class="typing-visual">
                <div class="keyboard-img">
                    <!-- Keyboard illustration using CSS -->
                    <div style="background: linear-gradient(45deg, #2d3436, #636e72); height: 180px; border-radius: 10px; display: flex; justify-content: center; align-items: center;">
                        <i class="fas fa-keyboard" style="font-size: 4rem; color: #a29bfe;"></i>
                    </div>
                </div>
